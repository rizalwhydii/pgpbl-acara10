...
<qgis version="3.24.0-Tisler">
  <identifier>garisjalandiy</identifier>
  <parentidentifier></parentidentifier>
  <language>ENG</language>
  <type>dataset</type>
  <title>garisjalandiy</title>
...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link description="" mimeType="" url="file://\\PSJSDS-4-PC\G$\TrainingPakuan.gdb" format="" name="File Geodatabase Feature Class" size="" type="Local Area Network"/>
  </links>
  <fees></fees>
